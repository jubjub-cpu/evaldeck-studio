...
function shell() {
  workspace.innerHTML = `<div class="studio-shell">
    ...
    <section class="workbench" aria-labelledby="workbench-title">
      ...
      <section class="slice-section" aria-labelledby="slice-heading"><div class="panel-heading"><div><p class="eyebrow">Slice health</p><h3 id="slice-heading">Performance by workflow</h3></div><span>Weighted total</span></div><div class="table-wrap" tabindex="0" aria-label="Slice performance table"><table><thead><tr><th>Slice</th><th>Cases</th><th>Baseline</th><th>Candidate</th><th>Delta</th></tr></thead><tbody id="slice-rows"></tbody></table></div></section>
